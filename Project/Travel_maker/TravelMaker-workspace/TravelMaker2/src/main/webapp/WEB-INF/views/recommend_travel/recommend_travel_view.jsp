...
<div class="container">
    ...
    <div class="content">
        <div class="content_img">
            <c:if test="${fn:startsWith(dto.recommend_travel_img, 'http')}">
                <img src="${dto.recommend_travel_img}"/>
            </c:if>
            <c:if test="${not fn:startsWith(dto.recommend_travel_img, 'http')}">
                <img src="${cpath}/travelImg/${dto.recommend_travel_img}"/>
            </c:if>
        </div>
    </div>
