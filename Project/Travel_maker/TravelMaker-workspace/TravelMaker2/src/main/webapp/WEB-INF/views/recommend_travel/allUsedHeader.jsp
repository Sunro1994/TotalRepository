...
<body>
        <div id="header-top">
        <div id="left">
            <a href= "http://ec2-3-34-52-179.ap-northeast-2.compute.amazonaws.com">
                <img src="${cpath}/img/TravelMakerlogo.png">
            </a>
        </div>
        <div id="center">
            <ul>
                <li><a href="http://ec2-3-34-52-179.ap-northeast-2.compute.amazonaws.com/" class="navBtn">홈</a></li>
	...
	*/
    ...
    if(KaKaoJoinBtn){
    	KaKaoJoinBtn.addEventListener("click", () => {
        	location.href= 'https://kauth.kakao.com/oauth/authorize?client_id=9810e4d47aa744b120cb9d4c343b295f&redirect_uri=http://ec2-54-180-94-237.ap-northeast-2.compute.amazonaws.com:8080/www/Member/KaKaoJoin&response_type=code';
        });
    }
