...
<dialog id="model">
		...
		<!--  KAKAO -->
            <div id="kakao">
            <a class="KaKaoLoginBtn" href="https://kauth.kakao.com/oauth/authorize?client_id=9810e4d47aa744b120cb9d4c343b295f&redirect_uri=http://ec2-54-180-94-237.ap-northeast-2.compute.amazonaws.com:8080/www/Member/KaKaoLogin&response_type=code">
