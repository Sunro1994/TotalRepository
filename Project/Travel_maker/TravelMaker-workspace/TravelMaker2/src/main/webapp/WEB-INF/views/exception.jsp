...
<script>
    ...
    // 서버에서 전달한 상태 코드와 오류 메시지를 가져오기
    const statusCode = <%= request.getAttribute("javax.servlet.error.status_code") %>;
    const errorMessage = '<%= request.getAttribute("javax.servlet.error.message") %>';
