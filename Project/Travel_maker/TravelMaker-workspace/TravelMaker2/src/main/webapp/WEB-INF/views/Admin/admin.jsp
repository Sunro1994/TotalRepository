...
<div class="navigation">
  ...
  <span style="--i:3;--x:0;--y:1;">
    <ion-icon name="alarm-outline"><a href="${cpath}/travel_promotion/travel_promotion_main">쿠폰</a></ion-icon>
  </span>
  <span style="--i:4;--x:1;--y:1;">
    <ion-icon name="game-controller-outline"><a href="${cpath}/recommend_travel/recommend_travel_main">여행추천</a></ion-icon>
  </span>
  ...
  <span style="--i:6;--x:0;--y:0;">
    <ion-icon name="notifications-outline"><a href="http://ec2-3-34-52-179.ap-northeast-2.compute.amazonaws.com">홈</a></ion-icon>
  </span>
  <span style="--i:7;--x:-1;--y:1;">
    <ion-icon name="water-outline"><a href="${cpath}/Meeting/meeting_main">만남</a></ion-icon>
  </span>
