...
public class KaKaoService {
	...
	public String getToken(String code) {
		...
		try {
			...
			sb.append("&redirect_uri=http://ec2-54-180-94-237.ap-northeast-2.compute.amazonaws.com:8080/www/Member/KaKaoLogin"); // TODO 인가코드 받은 redirect_uri 입력
			sb.append("&code=" + code );
	...
	public String getTokenForJoin(String code) {
		...
		try {
			...
			sb.append("grant_type=authorization_code");
			sb.append("&client_id=9810e4d47aa744b120cb9d4c343b295f"); // TODO REST_API_KEY 입력
			sb.append("&redirect_uri=http://ec2-54-180-94-237.ap-northeast-2.compute.amazonaws.com:8080/www/Member/KaKaoJoin"); // TODO 인가코드 받은 redirect_uri 입력
			sb.append("&code=" + code );
			bw.write(sb.toString());
			bw.flush();
