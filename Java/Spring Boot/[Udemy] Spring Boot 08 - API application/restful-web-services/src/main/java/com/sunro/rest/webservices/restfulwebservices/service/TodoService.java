...
public class TodoService {
    ...
    static {
        todos.add(new Todo(++todosCount, "sunro","Get AWS Certified",
                LocalDate.now().plusYears(10), false ));
        todos.add(new Todo(++todosCount, "sunro","Learn DevOps",
                LocalDate.now().plusYears(11), false ));
        todos.add(new Todo(++todosCount, "sunro","Learn Full Stack Development",
